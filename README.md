...
5- Todas las pruebas de módulos se hacen en QA. Si funciona bien actualizamos Produccion y Duplicamos Demo
...
8- Las pruebas que el un módulo funciona no se hacen local sino en QA y Luego en Demo.
